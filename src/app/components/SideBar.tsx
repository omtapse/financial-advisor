...
function SideBar({}: Props) {
  return (
    <div className='flex flex-col'>
        ...
        <div className='flex flex-col h-screen min-w-[230px] rounded-r-xl p-0 gap-4'>
            ...
            <button className='flex text-sm justify-center p-4 rounded-lg hover:bg-blue-400 min-w-[10px] min-h-[40px] text-gray-600 hover:text-white'>Sign Up In April</button>
        </div>      
